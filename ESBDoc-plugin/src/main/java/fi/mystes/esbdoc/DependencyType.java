...
public enum DependencyType {
    ...
    PROXY_ENDPOINT("proxyEndpoint", PROXY_ENDPOINT_XPATH_STRING, PROXY_ENDPOINT_ADDRESS_XPATH_STRING, 
    								PROXY_ENDPOINT_FAILOVER_GROUP_ADDRESS_XPATH_STRING, PROXY_ENDPOINT_FAILOVER_GROUP_HTTP_XPATH_STRING,
    								PROXY_ENDPOINT_HTTP_XPATH_STRING,
    								PROXY_ENDPOINT_LOADBALANCE_ADDRESS_XPATH_STRING, PROXY_ENDPOINT_LOADBALANCE_HTTP_XPATH_STRING, 
    								PROXY_ENDPOINT_RECIPIENT_LIST_ADDRESS_XPATH_STRING, PROXY_ENDPOINT_RECIPIENT_LIST_HTTP_XPATH_STRING),
